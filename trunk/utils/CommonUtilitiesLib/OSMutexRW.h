...
class TGMCOMUTI_API   OSMutexReadWriteLocker
{
    public:
...
class TGMCOMUTI_API   OSMutexReadLocker: public OSMutexReadWriteLocker
{
    public:
...
class TGMCOMUTI_API   OSMutexWriteLocker: public OSMutexReadWriteLocker
{
    public:
