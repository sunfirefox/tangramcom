...
#if defined(__GNUC__) && (((__GNUC__ == 4) && (__GNUC_MINOR_>1)) || (__GNUC__>4)) && defined(__OPTIMIZE__)
#define make_checker(func,type,arglist1,arglist2,namebuf,namebuflen,charsize)	\
extern void func##_sizeincorrect(void);						\
static inline type func##_ichk arglist1  {					\
	int namebuf##len = __builtin_object_size(namebuf, 0);			\
										\
	if (__builtin_constant_p(namebuflen) && (namebuf##len != -1) && (namebuflen*charsize > namebuf##len)) \
		func##_sizeincorrect();						\
	return func arglist2 ;							\
}

#define make_checker_indirect(func,type,arglist1,arglist2,namebuf,namebuflen,charsize)	\
extern void func##_sizeincorrect(void);						\
static inline type func##_ichk arglist1  {					\
	int namebuf##len = __builtin_object_size(namebuf, 0);			\
										\
...
#define make_checker2(func,type,arglist1,arglist2,name1buf,name1buflen,char1size,name2buf,name2buflen,char2size)	\
extern void func##_size1incorrect(void);						\
extern void func##_size2incorrect(void);						\
static inline type func##_ichk arglist1  {					\
	int name1buf##len = __builtin_object_size(name1buf, 0);			\
	int name2buf##len = __builtin_object_size(name2buf, 0);			\
										\
	if (__builtin_constant_p(name1buflen) && (name1buflen!=-1) && (name1buf##len != -1) && (name1buflen*char1size > name1buf##len)) \
		func##_size1incorrect();						\
	if (__builtin_constant_p(name2buflen) && (name2buflen!=-1) && (name2buf##len != -1) && (name2buflen*char2size > name2buf##len)) \
		func##_size2incorrect();						\
	return func arglist2 ;							\
}



make_checker(GetPrivateProfileStringA,INT WINAPI,(LPCSTR x,LPCSTR y,LPCSTR z,LPSTR a,UINT b,LPCSTR c),(x,y,z,a,b,c),a,b,1)
#define GetPrivateProfileStringA GetPrivateProfileStringA_ichk
make_checker(GetPrivateProfileStringW,INT WINAPI,(LPCWSTR x,LPCWSTR y,LPCWSTR z,LPWSTR a,UINT b,LPCWSTR c),(x,y,z,a,b,c),a,b,2)
#define GetPrivateProfileStringW GetPrivateProfileStringW_ichk
make_checker(GetProfileStringA,INT WINAPI,(LPCSTR x,LPCSTR y,LPCSTR z,LPSTR a,UINT b),(x,y,z,a,b),a,b,1)
#define GetProfileStringA GetProfileStringA_ichk
make_checker(GetProfileStringW,INT WINAPI,(LPCWSTR x,LPCWSTR y,LPCWSTR z,LPWSTR a,UINT b),(x,y,z,a,b),a,b,2)
#define GetProfileStringW GetProfileStringW_ichk
make_checker(GetProfileSectionA,INT WINAPI,(LPCSTR a, LPSTR b, DWORD c),(a,b,c),b,c,1)
#define GetProfileSectionA GetProfileSectionA_ichk
make_checker(GetProfileSectionW,INT WINAPI,(LPCWSTR a, LPWSTR b, DWORD c),(a,b,c),b,c,2)
#define GetProfileSectionW GetProfileSectionW_ichk
make_checker(GetPrivateProfileSectionA,INT WINAPI,(LPCSTR a,LPSTR b,DWORD c,LPCSTR d),(a,b,c,d),b,c,1)
#define GetPrivateProfileSectionA GetPrivateProfileSectionA_ichk
make_checker(GetPrivateProfileSectionW,INT WINAPI,(LPCWSTR a,LPWSTR b,DWORD c,LPCWSTR d),(a,b,c,d),b,c,2)
#define GetPrivateProfileSectionW GetPrivateProfileSectionW_ichk

make_checker(GetPrivateProfileSectionNamesA,DWORD WINAPI,(LPSTR a,DWORD b,LPCSTR c),(a,b,c),a,b,1)
#define GetPrivateProfileSectionNamesA GetPrivateProfileSectionNamesA_ichk
make_checker(GetPrivateProfileSectionNamesW,DWORD WINAPI,(LPWSTR a,DWORD b,LPCWSTR c),(a,b,c),a,b,2)
#define GetPrivateProfileSectionNamesW GetPrivateProfileSectionNamesW_ichk

make_checker(GetShortPathNameA,DWORD WINAPI,(LPCSTR a, LPSTR b, DWORD c),(a,b,c),b,c,1)
#define GetShortPathNameA GetShortPathNameA_ichk
make_checker(GetShortPathNameW,DWORD WINAPI,(LPCWSTR a, LPWSTR b, DWORD c),(a,b,c),b,c,2)
#define GetShortPathNameW GetShortPathNameW_ichk
make_checker(GetLongPathNameA,DWORD WINAPI,(LPCSTR a, LPSTR b, DWORD c),(a,b,c),b,c,1)
#define GetLongPathNameA GetLongPathNameA_ichk
make_checker(GetLongPathNameW,DWORD WINAPI,(LPCWSTR a, LPWSTR b, DWORD c),(a,b,c),b,c,2)
#define GetLongPathNameW GetLongPathNameW_ichk

make_checker(FindFirstVolumeA,HANDLE WINAPI,(LPSTR a,DWORD b),(a,b),a,b,1)
#define FindFirstVolumeA FindFirstVolumeA_ichk
make_checker(FindFirstVolumeW,HANDLE WINAPI,(LPWSTR a,DWORD b),(a,b),a,b,2)
#define FindFirstVolumeW FindFirstVolumeW_ichk
make_checker(FindNextVolumeA,BOOL WINAPI,(HANDLE h,LPSTR a,DWORD b),(h,a,b),a,b,1)
#define FindNextVolumeA FindNextVolumeA_ichk
make_checker(FindNextVolumeW,BOOL WINAPI,(HANDLE h,LPWSTR a,DWORD b),(h,a,b),a,b,2)
#define FindNextVolumeW FindNextVolumeW_ichk

make_checker(GetLogicalDriveStringsA,UINT WINAPI,(UINT a,LPSTR b),(a,b),b,a,1)
#define GetLogicalDriveStringsA GetLogicalDriveStringsA_ichk
make_checker(GetLogicalDriveStringsW,UINT WINAPI,(UINT a,LPWSTR b),(a,b),b,a,2)
#define GetLogicalDriveStringsW GetLogicalDriveStringsW_ichk

make_checker(GetTempPathA,DWORD WINAPI,(DWORD a,LPSTR b),(a,b),b,a,1)
#define GetTempPathA GetTempPathA_ichk
make_checker(GetTempPathW,DWORD WINAPI,(DWORD a,LPWSTR b),(a,b),b,a,2)
#define GetTempPathW GetTempPathW_ichk

make_checker(QueryDosDeviceA,DWORD WINAPI,(LPCSTR a,LPSTR b,DWORD c),(a,b,c),b,c,1)
#define QueryDosDeviceA QueryDosDeviceA_ichk
make_checker(QueryDosDeviceW,DWORD WINAPI,(LPCWSTR a,LPWSTR b,DWORD c),(a,b,c),b,c,2)
#define QueryDosDeviceW QueryDosDeviceW_ichk

make_checker(GetVolumeNameForVolumeMountPointA,BOOL WINAPI,(LPCSTR a,LPSTR b,DWORD c),(a,b,c),b,c,1)
#define GetVolumeNameForVolumeMountPointA GetVolumeNameForVolumeMountPointA_ichk
make_checker(GetVolumeNameForVolumeMountPointW,BOOL WINAPI,(LPCWSTR a,LPWSTR b,DWORD c),(a,b,c),b,c,2)
#define GetVolumeNameForVolumeMountPointW GetVolumeNameForVolumeMountPointW_ichk

make_checker(GetFullPathNameA,DWORD WINAPI,(LPCSTR a,DWORD b,LPSTR c,LPSTR*d),(a,b,c,d),c,b,1)
#define GetFullPathNameA GetFullPathNameA_ichk
make_checker(GetFullPathNameW,DWORD WINAPI,(LPCWSTR a,DWORD b,LPWSTR c,LPWSTR*d),(a,b,c,d),c,b,2)
#define GetFullPathNameW GetFullPathNameW_ichk

make_checker(GetDllDirectoryA,DWORD WINAPI,(DWORD a,LPSTR b),(a,b),b,a,1)
#define GetDllDirectoryA GetDllDirectoryA_ichk
make_checker(GetDllDirectoryW,DWORD WINAPI,(DWORD a,LPWSTR b),(a,b),b,a,2)
#define GetDllDirectoryW GetDllDirectoryW_ichk

make_checker(SearchPathA,DWORD WINAPI,(LPCSTR a,LPCSTR b,LPCSTR c,DWORD d,LPSTR e,LPSTR*f),(a,b,c,d,e,f),e,d,1)
#define SearchPathA SearchPathA_ichk
make_checker(SearchPathW,DWORD WINAPI,(LPCWSTR a,LPCWSTR b,LPCWSTR c,DWORD d,LPWSTR e,LPWSTR*f),(a,b,c,d,e,f),e,d,2)
#define SearchPathW SearchPathW_ichk

make_checker(GetModuleFileNameA,DWORD WINAPI,(HMODULE a,LPSTR b,DWORD c),(a,b,c),b,c,1)
#define GetModuleFileNameA GetModuleFileNameA_ichk
make_checker(GetModuleFileNameW,DWORD WINAPI,(HMODULE a,LPWSTR b,DWORD c),(a,b,c),b,c,2)
#define GetModuleFileNameW GetModuleFileNameW_ichk

make_checker(GetCurrentDirectoryA,UINT WINAPI,(UINT a,LPSTR b),(a,b),b,a,1)
#define GetCurrentDirectoryA GetCurrentDirectoryA_ichk
make_checker(GetCurrentDirectoryW,UINT WINAPI,(UINT a,LPWSTR b),(a,b),b,a,2)
#define GetCurrentDirectoryW GetCurrentDirectoryW_ichk

make_checker(GetTempFileNameA,UINT WINAPI,(LPCSTR a,LPCSTR b,UINT c,LPSTR d),(a,b,c,d),d,c,1)
#define GetTempFileNameA GetTempFileNameA_ichk
make_checker(GetTempFileNameW,UINT WINAPI,(LPCWSTR a,LPCWSTR b,UINT c,LPWSTR d),(a,b,c,d),d,c,2)
#define GetTempFileNameW GetTempFileNameW_ichk

make_checker(GetWindowsDirectoryA,UINT WINAPI,(LPSTR a,UINT b),(a,b),a,b,1)
#define GetWindowsDirectoryA GetWindowsDirectoryA_ichk
make_checker(GetWindowsDirectoryW,UINT WINAPI,(LPWSTR a,UINT b),(a,b),a,b,2)
#define GetWindowsDirectoryW GetWindowsDirectoryW_ichk

make_checker(GetSystemDirectoryA,UINT WINAPI,(LPSTR a,UINT b),(a,b),a,b,1)
#define GetSystemDirectoryA GetSystemDirectoryA_ichk
make_checker(GetSystemDirectoryW,UINT WINAPI,(LPWSTR a,UINT b),(a,b),a,b,2)
#define GetSystemDirectoryW GetSystemDirectoryW_ichk

make_checker(GetSystemWindowsDirectoryA,UINT WINAPI,(LPSTR a,UINT b),(a,b),a,b,1)
#define GetSystemWindowsDirectoryA GetSystemWindowsDirectoryA_ichk
make_checker(GetSystemWindowsDirectoryW,UINT WINAPI,(LPWSTR a,UINT b),(a,b),a,b,2)
#define GetSystemWindowsDirectoryW GetSystemWindowsDirectoryW_ichk

make_checker(GetAtomNameA,UINT WINAPI,(ATOM a,LPSTR b,INT c),(a,b,c),b,c,1)
#define GetAtomNameA GetAtomNameA_ichk
make_checker(GetAtomNameW,UINT WINAPI,(ATOM a,LPWSTR b,INT c),(a,b,c),b,c,2)
#define GetAtomNameW GetAtomNameW_ichk

make_checker(GlobalGetAtomNameA,UINT WINAPI,(ATOM a,LPSTR b,INT c),(a,b,c),b,c,1)
#define GlobalGetAtomNameA GlobalGetAtomNameA_ichk
make_checker(GlobalGetAtomNameW,UINT WINAPI,(ATOM a,LPWSTR b,INT c),(a,b,c),b,c,2)
#define GlobalGetAtomNameW GlobalGetAtomNameW_ichk

make_checker(ReadDirectoryChangesW,BOOL WINAPI,(HANDLE a,LPVOID b,DWORD c,BOOL d,DWORD e,LPDWORD f,LPOVERLAPPED g,LPOVERLAPPED_COMPLETION_ROUTINE h),(a,b,c,d,e,f,g,h),b,c,1)
#define ReadDirectoryChangesW ReadDirectoryChangesW_ichk

make_checker_indirect(DnsHostnameToComputerNameA,BOOL WINAPI,(LPCSTR a,LPSTR b,LPDWORD c),(a,b,c),b,c,1)
#define DnsHostnameToComputerNameA DnsHostnameToComputerNameA_ichk
make_checker_indirect(DnsHostnameToComputerNameW,BOOL WINAPI,(LPCWSTR a,LPWSTR b,LPDWORD c),(a,b,c),b,c,2)
#define DnsHostnameToComputerNameW DnsHostnameToComputerNameW_ichk

make_checker_indirect(GetComputerNameA,BOOL WINAPI,(LPSTR a,LPDWORD b),(a,b),a,b,1)
#define GetComputerNameA GetComputerNameA_ichk
make_checker_indirect(GetComputerNameW,BOOL WINAPI,(LPWSTR a,LPDWORD b),(a,b),a,b,2)
#define GetComputerNameW GetComputerNameW_ichk

make_checker_indirect(GetComputerNameExA,BOOL WINAPI,(COMPUTER_NAME_FORMAT a,LPSTR b,LPDWORD c),(a,b,c),b,c,1)
#define GetComputerNameExA GetComputerNameExA_ichk
make_checker_indirect(GetComputerNameExW,BOOL WINAPI,(COMPUTER_NAME_FORMAT a,LPWSTR b,LPDWORD c),(a,b,c),b,c,2)
#define GetComputerNameExW GetComputerNameExW_ichk

make_checker(GetEnvironmentVariableA,DWORD WINAPI,(LPCSTR a,LPSTR b,DWORD c),(a,b,c),b,c,1)
#define GetEnvironmentVariableA GetEnvironmentVariableA_ichk
make_checker(GetEnvironmentVariableW,DWORD WINAPI,(LPCWSTR a,LPWSTR b,DWORD c),(a,b,c),b,c,2)
#define GetEnvironmentVariableW GetEnvironmentVariableW_ichk
make_checker(ExpandEnvironmentStringsA,DWORD WINAPI,(LPCSTR a,LPSTR b,DWORD c),(a,b,c),b,c,1)
#define ExpandEnvironmentStringsA ExpandEnvironmentStringsA_ichk
make_checker(ExpandEnvironmentStringsW,DWORD WINAPI,(LPCWSTR a,LPWSTR b,DWORD c),(a,b,c),b,c,2)
#define ExpandEnvironmentStringsW ExpandEnvironmentStringsW_ichk

make_checker(ReadFileEx,BOOL WINAPI,(HANDLE a,LPVOID b,DWORD c,LPOVERLAPPED d,LPOVERLAPPED_COMPLETION_ROUTINE e),(a,b,c,d,e),b,c,1)
#define ReadFileEx ReadFileEx_ichk
make_checker(ReadFile,BOOL WINAPI,(HANDLE a,LPVOID b,DWORD c,LPDWORD d,LPOVERLAPPED e),(a,b,c,d,e),b,c,1)
#define ReadFile ReadFile_ichk

make_checker(WriteFileEx,BOOL WINAPI,(HANDLE a,LPCVOID b,DWORD c,LPOVERLAPPED d,LPOVERLAPPED_COMPLETION_ROUTINE e),(a,b,c,d,e),b,c,1)
#define WriteFileEx WriteFileEx_ichk
make_checker(WriteFile,BOOL WINAPI,(HANDLE a,LPCVOID b,DWORD c,LPDWORD d,LPOVERLAPPED e),(a,b,c,d,e),b,c,1)
#define WriteFile WriteFile_ichk

make_checker(_hread,LONG WINAPI,(HFILE a,LPVOID b,LONG c),(a,b,c),b,c,1)
#define _hread _hread_ichk
make_checker(_hwrite,LONG WINAPI,(HFILE a,LPCSTR b,LONG c),(a,b,c),b,c,1)
#define _hwrite _hwrite_ichk
make_checker(_lread,UINT WINAPI,(HFILE a,LPVOID b,UINT c),(a,b,c),b,c,1)
#define _lread _lread_ichk
make_checker(_lwrite,UINT WINAPI,(HFILE a,LPCSTR b,UINT c),(a,b,c),b,c,1)
#define _lwrite _lwrite_ichk

make_checker(ReadProcessMemory,BOOL WINAPI,(HANDLE a,LPCVOID b,LPVOID c,SIZE_T d,SIZE_T*e),(a,b,c,d,e),c,d,1)
#define ReadProcessMemory ReadProcessMemory_ichk
make_checker(WriteProcessMemory,BOOL WINAPI,(HANDLE a,LPVOID b,LPCVOID c,SIZE_T d,SIZE_T*e),(a,b,c,d,e),c,d,1)
#define WriteProcessMemory WriteProcessMemory_ichk

make_checker(GetPrivateProfileStructA,BOOL WINAPI,(LPCSTR a,LPCSTR b,LPVOID c,UINT d,LPCSTR e),(a,b,c,d,e),c,d,1)
#define GetPrivateProfileStructA GetPrivateProfileStructA_ichk
make_checker(GetPrivateProfileStructW,BOOL WINAPI,(LPCWSTR a,LPCWSTR b,LPVOID c,UINT d,LPCWSTR e),(a,b,c,d,e),c,d,1)
#define GetPrivateProfileStructW GetPrivateProfileStructW_ichk

make_checker(WritePrivateProfileStructA,BOOL WINAPI,(LPCSTR a,LPCSTR b,LPVOID c,UINT d,LPCSTR e),(a,b,c,d,e),c,d,1)
#define WritePrivateProfileStructA WritePrivateProfileStructA_ichk
make_checker(WritePrivateProfileStructW,BOOL WINAPI,(LPCWSTR a,LPCWSTR b,LPVOID c,UINT d,LPCWSTR e),(a,b,c,d,e),c,d,1)
#define WritePrivateProfileStructW WritePrivateProfileStructW_ichk

make_checker(UpdateResourceA,BOOL WINAPI,(HANDLE a,LPCSTR b,LPCSTR c,WORD d,LPVOID e,DWORD f),(a,b,c,d,e,f),e,f,1)
#define UpdateResourceA UpdateResourceA_ichk
make_checker(UpdateResourceW,BOOL WINAPI,(HANDLE a,LPCWSTR b,LPCWSTR c,WORD d,LPVOID e,DWORD f),(a,b,c,d,e,f),e,f,1)
#define UpdateResourceW UpdateResourceW_ichk

make_checker(WaitForMultipleObjects,DWORD WINAPI,(DWORD a,const HANDLE*b,BOOL c,DWORD d),(a,b,c,d),b,a,sizeof(HANDLE))
#define WaitForMultipleObjects WaitForMultipleObjects_ichk
make_checker(WaitForMultipleObjectsEx,DWORD WINAPI,(DWORD a,const HANDLE*b,BOOL c,DWORD d,BOOL e),(a,b,c,d,e),b,a,sizeof(HANDLE))
#define WaitForMultipleObjectsEx WaitForMultipleObjectsEx_ichk

make_checker2(TransactNamedPipe,BOOL WINAPI,(HANDLE a,LPVOID b,DWORD c,LPVOID d,DWORD e,LPDWORD f,LPOVERLAPPED g),(a,b,c,d,e,f,g),b,c,1,d,e,1)
#define TransactNamedPipe TransactNamedPipe_ichk

make_checker(PeekNamedPipe,BOOL WINAPI,(HANDLE a,PVOID b,DWORD c,PDWORD d,PDWORD e,PDWORD f),(a,b,c,d,e,f),b,c,1)
#define PeekNamedPipe PeekNamedPipe_ichk

make_checker2(CallNamedPipeA,BOOL WINAPI,(LPCSTR a,LPVOID b,DWORD c,LPVOID d,DWORD e,LPDWORD f,DWORD g),(a,b,c,d,e,f,g),b,c,1,d,e,1)
#define CallNamedPipeA CallNamedPipeA_ichk
make_checker2(CallNamedPipeW,BOOL WINAPI,(LPCWSTR a,LPVOID b,DWORD c,LPVOID d,DWORD e,LPDWORD f,DWORD g),(a,b,c,d,e,f,g),b,c,1,d,e,1)
#define CallNamedPipeW CallNamedPipeW_ichk

make_checker2(GetVolumeInformationA,BOOL WINAPI,(LPCSTR a,LPSTR b,DWORD c,LPDWORD d,LPDWORD e,LPDWORD f,LPSTR g,DWORD h),(a,b,c,d,e,f,g,h),b,c,1,g,h,1)
#define GetVolumeInformationA GetVolumeInformationA_ichk
make_checker2(GetVolumeInformationW,BOOL WINAPI,(LPCWSTR a,LPWSTR b,DWORD c,LPDWORD d,LPDWORD e,LPDWORD f,LPWSTR g,DWORD h),(a,b,c,d,e,f,g,h),b,c,2,g,h,2)
#define GetVolumeInformationW GetVolumeInformationW_ichk

make_checker(GetVolumePathNameA,BOOL WINAPI,(LPCSTR a,LPSTR b,DWORD c),(a,b,c),b,c,1)
#define GetVolumePathNameA GetVolumePathNameA_ichk
make_checker(GetVolumePathNameW,BOOL WINAPI,(LPCWSTR a,LPWSTR b,DWORD c),(a,b,c),b,c,2)
#define GetVolumePathNameW GetVolumePathNameW_ichk

make_checker(FindFirstVolumeMountPointA,HANDLE WINAPI,(LPCSTR a,LPSTR b,DWORD c),(a,b,c),b,c,1)
#define FindFirstVolumeMountPointA FindFirstVolumeMountPointA_ichk
make_checker(FindFirstVolumeMountPointW,HANDLE WINAPI,(LPCWSTR a,LPWSTR b,DWORD c),(a,b,c),b,c,2)
#define FindFirstVolumeMountPointW FindFirstVolumeMountPointW_ichk

make_checker2(DeviceIoControl,BOOL WINAPI,(HANDLE a,DWORD b,LPVOID c,DWORD d,LPVOID e,DWORD f,LPDWORD g,LPOVERLAPPED h),(a,b,c,d,e,f,g,h),c,d,1,e,f,1)
#define DeviceIoControl DeviceIoControl_ichk
