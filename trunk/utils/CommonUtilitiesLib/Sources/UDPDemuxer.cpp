...
//UDPDemuxer::UDPDemuxer() : fHashTable(kMaxHashTableSize), fMutex() {}

//UDPDemuxerHashTable*    UDPDemuxer::GetHashTable()  { return &fHashTable; }

//OSMutex*                UDPDemuxer::GetMutex()      { return &fMutex; }
