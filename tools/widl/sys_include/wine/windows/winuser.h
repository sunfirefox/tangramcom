...
make_checker(LoadStringA,INT WINAPI,(HINSTANCE a,UINT b,LPSTR c,INT d),(a,b,c,d),c,d,1)
#define LoadStringA LoadStringA_ichk
make_checker(LoadStringW,INT WINAPI,(HINSTANCE a,UINT b,LPWSTR c,INT d),(a,b,c,d),c,d,2)
#define LoadStringW LoadStringW_ichk

make_checker(GetClassNameA,INT WINAPI,(HWND a,LPSTR b,INT c),(a,b,c),b,c,1)
#define GetClassNameA GetClassNameA_ichk
make_checker(GetClassNameW,INT WINAPI,(HWND a,LPWSTR b,INT c),(a,b,c),b,c,2)
#define GetClassNameA GetClassNameA_ichk
