...
{
	FIXME("not implement RunningObjectTableImpl_Register");
	return E_NOTIMPL;
    //RunningObjectTableImpl *This = (RunningObjectTableImpl *)iface;
...
{
	FIXME("RunningObjectTableImpl_IsRunning Not Imple");
	return E_NOTIMPL;
   /* RunningObjectTableImpl *This = (RunningObjectTableImpl *)iface;
...
{
	FIXME("RunningObjectTableImpl_GetObject Not Imple");
	return E_NOTIMPL;
    /*RunningObjectTableImpl *This = (RunningObjectTableImpl *)iface;
    MonikerComparisonData *moniker_data;
    InterfaceData *object = NULL;
...
{
	FIXME("RunningObjectTableImpl_NoteChangeTime Not Imple");
	return E_NOTIMPL;
...
{
	FIXME("RunningObjectTableImpl_GetTimeOfLastChange Not Imple");
	return E_NOTIMPL;
...
{
	FIXME("RunningObjectTableImpl_EnumRunning Not Imple");
	return E_NOTIMPL;
    /*RunningObjectTableImpl *This = (RunningObjectTableImpl *)iface;
				...
				LPDWORD pchEaten, LPMONIKER *ppmk)
{
    ...
    //TRACE("(%p, %s, %p, %p)\n", pbc, TGMLOG_STR_W(szDisplayName), pchEaten, ppmk);
...
//
//    TRACE("%s, %p\n", TGMLOG_STR_W(filePathName), pclsid);
//
