...
make_checker(GetDateFormatA,INT WINAPI,(LCID a,DWORD b,const SYSTEMTIME*c,LPCSTR d,LPSTR e,INT f),(a,b,c,d,e,f),e,f,1)
#define GetDateFormatA GetDateFormatA_ichk
make_checker(GetDateFormatW,INT WINAPI,(LCID a,DWORD b,const SYSTEMTIME*c,LPCWSTR d,LPWSTR e,INT f),(a,b,c,d,e,f),e,f,2)
#define GetDateFormatW GetDateFormatW_ichk
make_checker(GetTimeFormatA,INT WINAPI,(LCID a,DWORD b,const SYSTEMTIME*c,LPCSTR d,LPSTR e,INT f),(a,b,c,d,e,f),e,f,1)
#define GetTimeFormatA GetTimeFormatA_ichk
make_checker(GetTimeFormatW,INT WINAPI,(LCID a,DWORD b,const SYSTEMTIME*c,LPCWSTR d,LPWSTR e,INT f),(a,b,c,d,e,f),e,f,2)
#define GetTimeFormatW GetTimeFormatW_ichk

make_checker(GetNumberFormatA,INT WINAPI,(LCID a,DWORD b,LPCSTR c,const NUMBERFMTA*d,LPSTR e,INT f),(a,b,c,d,e,f),e,f,1)
#define GetNumberFormatA GetNumberFormatA_ichk
make_checker(GetNumberFormatW,INT WINAPI,(LCID a,DWORD b,LPCWSTR c,const NUMBERFMTW*d,LPWSTR e,INT f),(a,b,c,d,e,f),e,f,2)
#define GetNumberFormatW GetNumberFormatW_ichk

make_checker(GetCurrencyFormatA,INT WINAPI,(LCID a,DWORD b,LPCSTR c,const CURRENCYFMTA*d,LPSTR e,INT f),(a,b,c,d,e,f),e,f,1)
#define GetCurrencyFormatA GetCurrencyFormatA_ichk
make_checker(GetCurrencyFormatW,INT WINAPI,(LCID a,DWORD b,LPCWSTR c,const CURRENCYFMTW*d,LPWSTR e,INT f),(a,b,c,d,e,f),e,f,2)
#define GetCurrencyFormatW GetCurrencyFormatW_ichk

make_checker(LCIDToLocaleName,INT WINAPI,(LCID a,LPWSTR b,INT c,DWORD d),(a,b,c,d),b,c,2)
#define LCIDToLocaleName LCIDToLocaleName_ichk

make_checker(GetLocaleInfoA,INT WINAPI,(LCID a,LCTYPE b,LPSTR c,INT d),(a,b,c,d),c,d,1)
#define GetLocaleInfoA GetLocaleInfoA_ichk
make_checker(GetLocaleInfoW,INT WINAPI,(LCID a,LCTYPE b,LPWSTR c,INT d),(a,b,c,d),c,d,2)
#define GetLocaleInfoW GetLocaleInfoW_ichk

make_checker(GetStringTypeExA,BOOL WINAPI,(LCID a,DWORD b,LPCSTR c,INT d,LPWORD e),(a,b,c,d,e),c,d,1)
#define GetStringTypeExA GetStringTypeExA_ichk
make_checker(GetStringTypeExW,BOOL WINAPI,(LCID a,DWORD b,LPCWSTR c,INT d,LPWORD e),(a,b,c,d,e),c,d,2)
#define GetStringTypeExW GetStringTypeExW_ichk

make_checker(GetStringTypeA,BOOL WINAPI,(LCID a,DWORD b,LPCSTR c,INT d,LPWORD e),(a,b,c,d,e),c,d,1)
#define GetStringTypeA GetStringTypeA_ichk
make_checker(GetStringTypeW,BOOL WINAPI,(DWORD a,LPCWSTR b,INT c,LPWORD d),(a,b,c,d),b,c,2)
#define GetStringTypeB GetStringTypeB_ichk

make_checker2(WideCharToMultiByte,INT WINAPI,(UINT a,DWORD b,LPCWSTR c,INT d,LPSTR e,INT f,LPCSTR g,LPBOOL h),(a,b,c,d,e,f,g,h),c,d,2,e,f,1)
#define WideCharToMultiByte WideCharToMultiByte_ichk
make_checker2(MultiByteToWideChar,INT WINAPI,(UINT a,DWORD b,LPCSTR c,INT d,LPWSTR e,INT f),(a,b,c,d,e,f),c,d,1,e,f,2)
#define MultiByteToWideChar MultiByteToWideChar_ichk

#if 0 /* API sucks */
make_checker2(LCMapStringA,INT WINAPI,(LCID a,DWORD b,LPCSTR c,INT d,LPSTR e,INT f),(a,b,c,d,e,f),c,d,1,e,f,1)
#define LCMapStringA LCMapStringA_ichk
make_checker2(LCMapStringW,INT WINAPI,(LCID a,DWORD b,LPCWSTR c,INT d,LPWSTR e,INT f),(a,b,c,d,e,f),c,d,2,e,f,2)
#define LCMapStringW LCMapStringW_ichk
#endif

make_checker2(FoldStringA,INT WINAPI,(DWORD a,LPCSTR b,INT c,LPSTR d,INT e),(a,b,c,d,e),b,c,1,d,e,1)
#define FoldStringA FoldStringA_ichk
make_checker2(FoldStringW,INT WINAPI,(DWORD a,LPCWSTR b,INT c,LPWSTR d,INT e),(a,b,c,d,e),b,c,2,d,e,2)
#define FoldStringA FoldStringA_ichk

make_checker2(CompareStringA,INT WINAPI,(LCID a,DWORD b,LPCSTR c,INT d,LPCSTR e,INT f),(a,b,c,d,e,f),c,d,1,e,f,1)
#define CompareStringA CompareStringA_ichk
make_checker2(CompareStringW,INT WINAPI,(LCID a,DWORD b,LPCWSTR c,INT d,LPCWSTR e,INT f),(a,b,c,d,e,f),c,d,2,e,f,2)
#define CompareStringW CompareStringW_ichk

make_checker(GetCalendarInfoA,INT WINAPI,(LCID a,DWORD b,DWORD c,LPSTR d,INT e,LPDWORD f),(a,b,c,d,e,f),d,e,1)
#define GetCalendarInfoA GetCalendarInfoA_ichk
make_checker(GetCalendarInfoW,INT WINAPI,(LCID a,DWORD b,DWORD c,LPWSTR d,INT e,LPDWORD f),(a,b,c,d,e,f),d,e,2)
#define GetCalendarInfoW GetCalendarInfoW_ichk

#endif /* overflow checker */
