...
class TGMCOMUTI_API OSRefTableUtils
{
    private:
...
class  OSRefTable
{
    public:
        ...
        TGMCOMUTI_API OSRefTable(UInt32 tableSize = kDefaultTableSize) : fTable(tableSize), fMutex() {}
        TGMCOMUTI_API ~OSRefTable() {}
        
        //Allows access to the mutex in case you need to lock the table down
        //between operations
        TGMCOMUTI_API OSMutex*    GetMutex()      { return &fMutex; }
        TGMCOMUTI_API OSRefHashTable* GetHashTable() { return &fTable; }
        ...
        TGMCOMUTI_API OS_Error        Register(OSRef* ref);
        ...
        TGMCOMUTI_API OSRef*              RegisterOrResolve(OSRef* inRef);
        ...
        //This function is atomic wrt this ref table.
        TGMCOMUTI_API void        UnRegister(OSRef* ref, UInt32 refCount = 0);
        
        // Same as UnRegister, but guarenteed not to block. Will return
        // true if ref was sucessfully unregistered, false otherwise
        TGMCOMUTI_API Bool16      TryUnRegister(OSRef* ref, UInt32 refCount = 0);
        ...
        //This function is atomic wrt this ref table.
        TGMCOMUTI_API OSRef*      Resolve(StrPtrLen*  inString);
        ...
        TGMCOMUTI_API void        Release(OSRef*  inRef);
        ...
        TGMCOMUTI_API void        Swap(OSRef* newRef);
        
        TGMCOMUTI_API UInt32      GetNumRefsInTable() { UInt64 result =  fTable.GetNumEntries(); Assert(result < kUInt32_Max); return (UInt32) result; }
...
class TGMCOMUTI_API OSRefReleaser
{
    public:
