...
static OSMutex& get_global_critial_section_mutex()
{
	static OSMutex ins;
	return ins;
}

OSGlobalCriticalSection::OSGlobalCriticalSection()
{
	get_global_critial_section_mutex().Lock();
}
OSGlobalCriticalSection::~OSGlobalCriticalSection()
{
	get_global_critial_section_mutex().Unlock();
}
