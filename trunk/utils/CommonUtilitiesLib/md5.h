...
TGMCOMUTI_API void   MD5_Init(MD5_CTX *context);
TGMCOMUTI_API void   MD5_Update(MD5_CTX *context, unsigned char *input, unsigned int inputLen);
TGMCOMUTI_API void   MD5_Final(unsigned char digest[16], MD5_CTX *context);
