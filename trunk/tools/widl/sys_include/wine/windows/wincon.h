...
make_checker(WriteConsoleInputA,BOOL WINAPI,(HANDLE a,const INPUT_RECORD *b,DWORD c,LPDWORD d),(a,b,c,d),b,c,sizeof(INPUT_RECORD))
#define WriteConsoleInputA WriteConsoleInputA_ichk
make_checker(WriteConsoleInputW,BOOL WINAPI,(HANDLE a,const INPUT_RECORD *b,DWORD c,LPDWORD d),(a,b,c,d),b,c,sizeof(INPUT_RECORD))
#define WriteConsoleInputW WriteConsoleInputW_ichk

make_checker(WriteConsoleOutputCharacterA,BOOL WINAPI,(HANDLE a,LPCSTR b,DWORD c,COORD d,LPDWORD e),(a,b,c,d,e),b,c,1)
#define WriteConsoleOutputCharacterA WriteConsoleOutputCharacterA_ichk
make_checker(WriteConsoleOutputCharacterW,BOOL WINAPI,(HANDLE a,LPCWSTR b,DWORD c,COORD d,LPDWORD e),(a,b,c,d,e),b,c,2)
#define WriteConsoleOutputCharacterW WriteConsoleOutputCharacterW_ichk

make_checker(ReadConsoleOutputCharacterA,BOOL WINAPI,(HANDLE a,LPSTR b,DWORD c,COORD d,LPDWORD e),(a,b,c,d,e),b,c,1)
#define ReadConsoleOutputCharacterA ReadConsoleOutputCharacterA_ichk
make_checker(ReadConsoleOutputCharacterW,BOOL WINAPI,(HANDLE a,LPWSTR b,DWORD c,COORD d,LPDWORD e),(a,b,c,d,e),b,c,2)
#define ReadConsoleOutputCharacterW ReadConsoleOutputCharacterW_ichk

make_checker(ReadConsoleInputA,BOOL WINAPI,(HANDLE a,PINPUT_RECORD b,DWORD c,LPDWORD d),(a,b,c,d),b,c,sizeof(INPUT_RECORD))
#define ReadConsoleInputA ReadConsoleInputA_ichk
make_checker(ReadConsoleInputW,BOOL WINAPI,(HANDLE a,PINPUT_RECORD b,DWORD c,LPDWORD d),(a,b,c,d),b,c,sizeof(INPUT_RECORD))
#define ReadConsoleInputW ReadConsoleInputW_ichk

make_checker(PeekConsoleInputA,BOOL WINAPI,(HANDLE a,PINPUT_RECORD b,DWORD c,LPDWORD d),(a,b,c,d),b,c,sizeof(INPUT_RECORD))
#define PeekConsoleInputA PeekConsoleInputA_ichk
make_checker(PeekConsoleInputW,BOOL WINAPI,(HANDLE a,PINPUT_RECORD b,DWORD c,LPDWORD d),(a,b,c,d),b,c,sizeof(INPUT_RECORD))
#define PeekConsoleInputW PeekConsoleInputW_ichk

make_checker(GetConsoleInputExeNameA,BOOL WINAPI,(DWORD a,LPSTR b),(a,b),b,a,1)
#define GetConsoleInputExeNameA GetConsoleInputExeNameA_ichk
make_checker(GetConsoleInputExeNameW,BOOL WINAPI,(DWORD a,LPWSTR b),(a,b),b,a,2)
#define GetConsoleInputExeNameW GetConsoleInputExeNameW_ichk

make_checker(GetConsoleTitleA,BOOL WINAPI,(LPSTR a,DWORD b),(a,b),a,b,1)
#define GetConsoleTitleA GetConsoleTitleA_ichk
make_checker(GetConsoleTitleW,BOOL WINAPI,(LPWSTR a,DWORD b),(a,b),a,b,2)
#define GetConsoleTitleW GetConsoleTitleW_ichk

make_checker(ReadConsoleA,BOOL WINAPI,(HANDLE a,LPVOID b,DWORD c,LPDWORD d,LPVOID e),(a,b,c,d,e),b,c,1)
#define ReadConsoleA ReadConsoleA_ichk
make_checker(ReadConsoleW,BOOL WINAPI,(HANDLE a,LPVOID b,DWORD c,LPDWORD d,LPVOID e),(a,b,c,d,e),b,c,2)
#define ReadConsoleW ReadConsoleW_ichk

make_checker(WriteConsoleA,BOOL WINAPI,(HANDLE a,CONST VOID *b,DWORD c,LPDWORD d,LPVOID e),(a,b,c,d,e),b,c,1)
#define WriteConsoleA WriteConsoleA_ichk
make_checker(WriteConsoleW,BOOL WINAPI,(HANDLE a,CONST VOID *b,DWORD c,LPDWORD d,LPVOID e),(a,b,c,d,e),b,c,2)
#define WriteConsoleW WriteConsoleW_ichk

#endif /* overflow checking */
