...
#ifndef _RPCUNIXCONNECTION_H_
#define _RPCUNIXCONNECTION_H_
...
{
	class CRpcUnixConnection:public IUnknownImp<ITgmRpcConnection>,public Task
	{                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
	public:
		CRpcUnixConnection(BOOL isServer = FALSE, BOOL isSimple = FALSE);
		virtual ~CRpcUnixConnection();
	...
	public:
		...
		UnixSocket&				get_Socket(){return mSocket;}
		HRESULT					Connect(const char* inPath);//just for client connecting to server
...
#endif	// End of _RPCUNIXCONNECTION_H_
