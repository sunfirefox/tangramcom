 ...
 */
#define  _EXPORT_STANDARD_PROXY_DLLROUTINES_
...
static const char ole32_name_A[] = "tgmole32.dll";
...
static WCHAR const interface_keyname[10] = {
    'I','n','t','e','r','f','a','c','e',0 };	//Interface
static WCHAR const base_ifa_keyname[14] = {		//BaseInterface
    'B','a','s','e','I','n','t','e','r','f','a','c','e',0 };
static WCHAR const num_methods_keyname[11] = {	//NumMethods
    'N','u','m','M','e','t','h','o','d','s',0 };
static WCHAR const ps_clsid_keyname[15] = {		//ProxyStubClsid
    'P','r','o','x','y','S','t','u','b','C','l','s','i','d',0 };
static WCHAR const ps_clsid32_keyname[17] = {	//ProxyStubClsid32
    'P','r','o','x','y','S','t','u','b','C','l','s','i','d','3','2',0 };
static WCHAR const clsid_keyname[6] = {//CLSID
    'C','L','S','I','D',0 };
static WCHAR const ips_keyname[13] = {	//InprocServer
    'I','n','p','r','o','c','S','e','r','v','e','r',0 };
static WCHAR const ips32_keyname[15] = {//InprocServer32
    'I','n','p','r','o','c','S','e','r','v','e','r','3','2',0 };
static WCHAR const progid_keyname[7] = {//ProgID
    'P','r','o','g','I','D',0 };
