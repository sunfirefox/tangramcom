...
class TGMCOMUTI_API StrPtrLen
{
    public:
        ...
        StrPtrLen(char* sp) : Ptr(sp), Len(sp != NULL ? (UInt32)strlen(sp) : 0) {}
        ...
        void Set(char* inPtr) { Ptr = inPtr; Len = (inPtr) ?  (UInt32)::strlen(inPtr) : 0; }
...
class TGMCOMUTI_API StrPtrLenDel : public StrPtrLen
{
  public:
