#define REGISTRERY_IMPLEMENT_XML
...
class TGMCOMUTI_API DTDVerifier
{
public:
...
public:
    ...
    void SetAttribute(char* attrName, char* attrValue);
...
class TGMCOMUTI_API XMLAttribute
{
public:
    XMLAttribute();
    ~XMLAttribute();
...
#endif//#ifdef  REGISTRERY_IMPLEMENT_XML
